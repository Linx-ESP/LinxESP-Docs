# Tiendas, suscripciones y launchers  
...
- Extras:
    ...
    - [Skin: Metro (No funcional con nueva interfaz)](https://steamcommunity.com/groups/metroskin/discussions/0/141136086931804907/)
...
- Alternativa CLI (para Playnite por ejemplo): [Legendary](https://github.com/derrod/legendary)
...
Recomendaciones:
- Tema escritorio: DH_dawn / Haze
- Tema pantalla completa: Hero / Anthem
- Plugins:
    -  Bibliotecas
        - Legendary en vez de Epic Games Launcher
        . MultiMC para Minecraft / Prism Launcher
    - Fuente de metadatos
        - GameTDB para Wii y Gamecube (para Dolphin)
        - LaunchBox para juegos de consolas (para emuladores)
        - PCGamingWiki para enlaces y etiquetas por características
        - MetadataLocal para descripciones traducidas de otras fuentes.
    - Genérica
        - Cooperative Modes Importer
        - Duplicate Hider
        - Extra Metadata Loader: Desactivar videos, mantener logos
